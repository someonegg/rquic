...
#define XQC_PACKET_OUT_EXT_SPACE (XQC_ACK_SPACE)
...
typedef enum {
    ...
    XQC_POF_SPURIOUS_LOSS       = 1 << 10,
    XQC_POF_STREAM_NO_LEN       = 1 << 11,  /* for stream without LEN bit, shouldn't attach different frame to it */
