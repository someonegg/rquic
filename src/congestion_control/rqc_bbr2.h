...
#ifndef _RQC_BBR2_H_INCLUDED_
#define _RQC_BBR2_H_INCLUDED_
...
typedef struct rqc_bbr2_s {
    ...
    rqc_usec_t          probe_rtt_round_done_stamp;
    ...
    rqc_usec_t          last_round_trip_time;
    ...
    rqc_usec_t              recovery_start_time;
    bool                    packet_conservation;
    rqc_usec_t              loss_start_time;
    rqc_bbr2_recovery_mode  recovery_mode;

#if RQC_BBR2_PLUS_ENABLED
    /* For BBRv2+ */
    rqc_win_filter_t        max_rtt;
    uint32_t                max_rtt_win_len;
    uint32_t                rtt_compensation_thresh;
    uint8_t                 rtt_compensation_on;
    uint8_t                 fast_convergence_on;
    rqc_usec_t              srtt_in_last_round;
    rqc_usec_t              srtt_in_current_round;
...
#endif
} rqc_bbr2_pacing_gain_phase;

typedef struct rqc_bbr2_context_s {
    uint32_t sample_bw;
    uint32_t target_cwnd;
} rqc_bbr2_context_t;

extern const rqc_cong_ctrl_callback_t rqc_bbr2_cb;
